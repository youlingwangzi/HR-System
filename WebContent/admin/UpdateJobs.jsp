...
String postDepartId = request.getParameter("job_id");//用request得到 
 %> 
		...
		<table border="0" width="950" height="350" bgcolor="#ffffff"
			...
			<tr>
				<td align="center" valign="top">
					<form method="post" action="UpdateJobsServlet.do">
						<table width="500" border="0" cellpadding="5" cellspacing="1"
							...
							<tr>
								<td height="24" colspan="2" align="center" bgcolor="#FFFFFF">
									<input type="submit" name="Submit" value="更新" onClick="alert('修改职务成功');location.href='JobsViewServlet.do'">
